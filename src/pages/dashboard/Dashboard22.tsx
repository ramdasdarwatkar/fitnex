...
export const Dashboard22 = () => {
  return (
    /* 1. min-h-screen: Background hits the bottom.
      2. pt-[env(safe-area-inset-top)]: Skips the notch area.
      3. pb-32: Clearance for BottomNav.
    */
    <div className="flex-1 flex flex-col bg-[var(--bg-main)] px-6 space-y-4 min-h-screen pb-32 pt-[env(safe-area-inset-top)] mt-4">
        ...
        <div className="group relative w-full h-44 border border-slate-800 rounded-[2.5rem] overflow-hidden transition-all active:scale-[0.98]">
          ...
          <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end">
            <div className="space-y-1">
              ...
              <h4 className="text-xl font-black uppercase italic leading-none text-white">
                Full Body Power
              </h4>
            </div>
